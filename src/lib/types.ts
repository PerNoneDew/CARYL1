...
export interface Cottage {
  ...
  pricePerNight: number;
  capacity: number;
  status: 'available' | 'reserved' | 'occupied' | 'maintenance' | 'unavailable';
  image?: string;
}
...
export interface BusinessInfo {
  ...
  functionHallTables?: number;
  functionHallChairs?: number;
  functionHallScheduleStart?: string;
  functionHallScheduleEnd?: string;
