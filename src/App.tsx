...
function AppContent() {
  ...
  return (
    <Routes>
      ...
      <Route path="/customer/events" element={<Navigate to="/customer/facilities" replace />} />
      <Route path="/customer/facilities" element={<Protected allow={['customer']}><CustomerFacilitiesPage /></Protected>} />
      <Route path="/customer/settings" element={<Protected allow={['customer']}><CustomerSettingsPage /></Protected>} />
      <Route path="/customer/food-order" element={<Navigate to="/customer/facilities" replace />} />
      ...
      <Route path="/staff/rooms" element={<Protected allow={['staff']}><StaffRoomsPage /></Protected>} />
      <Route path="/staff/events" element={<Navigate to="/staff/facilities" replace />} />
      ...
      <Route path="/staff/payments" element={<Protected allow={['staff']}><StaffPaymentsPage /></Protected>} />
      <Route path="/staff/food-orders" element={<Navigate to="/staff/facilities" replace />} />
      <Route path="/staff/maintenance" element={<Navigate to="/staff" replace />} />
    </Routes>
  );
}
