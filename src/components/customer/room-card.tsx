...
export function RoomCard({ room, onBook, isAvailable }: RoomCardProps) {
  return (
    <div className="room-card-float bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            className="room-card-book-btn bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400"
          >
