...
const menuItems = [
  ...
  { label: 'Guest List', href: '/admin/guests', icon: Users },
  { label: 'Account Management', href: '/admin/staff', icon: UserPlus },
  ...
  return (
    <>
      ...
      <aside
        ...
        } fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-slate-800 to-slate-700 text-white transition-transform duration-300 md:translate-x-0 md:static md:h-screen md:shrink-0 z-40 flex flex-col`}
      >
