          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-9 h-9 text-sm bg-amber-950/60 border-amber-700 text-amber-50 placeholder-amber-300/60 focus:border-amber-400 focus:ring-amber-400 rounded-md"
                required
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-3 text-amber-300 hover:text-amber-100 transition-colors"
              >
