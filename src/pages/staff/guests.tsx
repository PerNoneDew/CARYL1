...
import { Search, Users, Mail, Phone, BedDouble, Calendar, Printer } from 'lucide-react';
                              ...
                              <div className="flex items-center gap-3 text-sm">
                                {(() => {
                                  ...
                                  return img ? (
                                    ...
                                    <div className="w-20 h-16 rounded-lg bg-blue-50 flex items-center justify-center border border-gray-200">
